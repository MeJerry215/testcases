...
## [Nsight CLI](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html)
...
| ------- | ----------- | ------- |
| k,kernel-name | 只profile名称匹配的kernel，或者regex:<expression> |         |
| s,launch-skip | 在profile之前跳过多少次的lauch,受kernel filters影响的kernel | |
| list-metrics  | | |
| query-metrics | | |
| metrics       | | |
|disable-profiler-start-stop| cu(da)ProfilerStart/Stop 受到影响 |
| log-file      | 全部的运日志，如果没有指定就打印到console | |
| o,export      | 最终输出的结果文件 | |
| f,force-overwrite | 允许重写 | |
